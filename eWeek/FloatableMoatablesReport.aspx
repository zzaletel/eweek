<%@ Page visible="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FloatableMoatablesReport.aspx.cs" Inherits="ASPWenFormPractice1.FloatableMoatablesReport" %>
<script runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        DeleteCommand="DELETE FROM floatable_moatable_report WHERE record_id=?;"
