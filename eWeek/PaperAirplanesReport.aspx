<%@ Page visible="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaperAirplanesReport.aspx.cs" Inherits="ASPWenFormPractice1.PaperAirplanesReport" EnableEventValidation="false"%>
<script runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        DeleteCommand="DELETE FROM paper_airplanes_report WHERE record_id=@record_id;"
