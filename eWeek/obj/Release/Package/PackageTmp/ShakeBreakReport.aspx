<%@ Page visible="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShakeBreakReport.aspx.cs" Inherits="ASPWenFormPractice1.ShakeBreakReport" EnableEventValidation="false"%>
<script runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        SelectCommand="SELECT * FROM shake_and_break_report;"
        DeleteCommand="DELETE FROM shake_and_break_report WHERE record_id=@record_id;"
