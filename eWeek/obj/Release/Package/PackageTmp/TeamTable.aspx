...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server"
        ...
        UpdateCommand="Update team SET name=@name,member_names=@member_names,team_size=@team_size, representative_id=@representative_id, WHERE team_id=@team_id"
        OnUpdated="OnDSUpdatedHandler"
        DeleteCommand="DELETE FROM team WHERE team_id=@team_id;"
