<%@ Page visible="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EggTossReport.aspx.cs" Inherits="ASPWenFormPractice1.EggTossReport" EnableEventValidation="false"%>
<script runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM egg_toss_report;"
        DeleteCommand="DELETE FROM egg_toss_report WHERE record_id=@record_id;"
