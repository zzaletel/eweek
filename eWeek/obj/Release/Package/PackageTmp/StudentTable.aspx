...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:eweekDb %>" ProviderName="<%$ ConnectionStrings:eweekDb.ProviderName %>" 
        ...
        UpdateCommand="Update dbo.student SET name=@name,school=@school,grade=@grade WHERE student_id=@student_id"
        DeleteCommand="DELETE FROM dbo.student WHERE student_id=@student_id;">
    </asp:SqlDataSource>
    <br /><br /><br />
