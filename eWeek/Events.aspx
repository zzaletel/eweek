<%@ Page Title="Report Data Entry" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="ASPWenFormPractice1.WebForm2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Events</h2>
    <ul>
        <li><a id="A1" runat="server" href="~/EggDrop">Egg drop - team or individual</a></li>
