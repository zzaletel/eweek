<%@ Page visible="false" Title="Tower of Power Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TowerOfPowerReport.aspx.cs" Inherits="ASPWenFormPractice1.TowerOfPowerReport" EnableEventValidation="false"%>
<script runat="server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        ProviderName="<%$ ConnectionStrings:eweekDb.ProviderName %>"
         SelectCommand="SELECT * FROM tower_of_power;"
    DeleteCommand="DELETE FROM tower_of_power WHERE record_id=@record_id;"
